          ...
          <div className="flex justify-center lg:justify-end w-full lg:w-auto order-1 lg:order-2 stagger" style={{ "--delay": "0.2s" } as React.CSSProperties}>
            <div className="relative">
              ...
              <div className="relative w-72 sm:w-84 aspect-[4/4.8] rounded-3xl p-5 bg-gradient-to-b from-purple-500/25 via-slate-950/85 to-[#110720] border border-purple-500/40 backdrop-blur-xl shadow-2xl shadow-purple-950/80 group animate-border-pulse hover:animate-none hover:border-purple-400/70 transition-colors duration-500">
                ...
                {/* inner canvas */}
                <div className="relative w-full h-full rounded-2xl overflow-hidden bg-gradient-to-b from-[#1c0b36] via-[#110720] to-[#0a0314] border border-purple-400/30 flex flex-col items-center justify-between p-6 shadow-inner">
                  ...
                  {/* 3D BH */}
                  <div className="relative z-10 my-auto select-none cursor-default group-hover:scale-108 transition-transform duration-500 text-center">
                    <div className="text-8xl sm:text-9xl tracking-tighter text-3d-bh font-black leading-none">
                      BH
                    </div>
                    <div className="mt-4 text-xs uppercase tracking-[0.4em] text-purple-200/90 font-bold animate-fade-in" style={{ animationDelay: "0.8s", opacity: 0 }}>
                      Balaji H
                    </div>
                  </div>

                  {/* Code badge */}
                  <div className="relative z-10 w-full pt-3 border-t border-purple-500/20">
                ...
                {/* Floating badges */}
                <div className="absolute -top-3 -right-3 px-3.5 py-1.5 rounded-xl bg-purple-900/95 border border-purple-400/50 text-purple-200 text-xs font-bold shadow-xl shadow-purple-950/90 flex items-center gap-1.5 animate-bounce">
                  <span>⚡</span><span>MERN + AI</span>
                </div>
                <div className="absolute -bottom-3 -left-3 px-3.5 py-1.5 rounded-xl bg-slate-900/95 border border-purple-400/40 text-emerald-400 text-xs font-semibold shadow-xl shadow-black/90 flex items-center gap-1.5">
